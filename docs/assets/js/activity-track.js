document.addEventListener('DOMContentLoaded', () => {
  const apiUrl = `https://api.lanyard.rest/v1/users/${GLOBAL_SETTINGS.UserID}`;
  ...
  async function updateDiscordStatus() {
    try {
      ...
      if (data.success) {
        ...
        const avatarUrl = `https://cdn.discordapp.com/avatars/${GLOBAL_SETTINGS.UserID}/${discord.discord_user.avatar}.png`;
