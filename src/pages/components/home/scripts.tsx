export const scripts = () => {
    return (<scripts>
        <script src="/js/modules/day.js"></script>
        <script src="/js/modules/duration.js"></script>
        <script src="/js/modules/typewritter.js"></script>
        ...
        <script src="/js/main/audio-visualizer.js"></script>
        <script type="module" src="/js/main/music-player.js"></script>
